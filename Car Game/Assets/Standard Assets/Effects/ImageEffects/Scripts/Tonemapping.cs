...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class Tonemapping : PostEffectsBase
    {
        ...
        private Material CheckShaderAndCreateMaterial(Shader tonemapper, Material tonemapMaterial)
        {
            throw new NotImplementedException();
        }

        private void CheckSupport(bool v1, bool v2)
        {
            throw new NotImplementedException();
        }
        ...
        private void DestroyImmediate(Texture2D curveTex)
        {
            throw new NotImplementedException();
        }

        private void DestroyImmediate(Material tonemapMaterial)
        {
            throw new NotImplementedException();
        }

        private void DestroyImmediate(RenderTexture rt)
        {
            throw new NotImplementedException();
        }
